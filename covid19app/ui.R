        ...
        dashboardBody(
            tabItems(
                ...
                tabItem(tabName = "Home",
                        fluidPage(
                            column(width = 12, 
                                h1("first trimester Coronavirus analysis 2020"),
                                ...
                                a(href = "https://www.ecdc.europa.eu/en/
                                  ...
                                  worldwide", "This dataset was obtained from 
                                  European Centre for Disease Prevention and
                                  Control"), 
                                h3("Code source"),
                                a(href = "https://github.com/leosquintero/Covid
                                  -19-analysis", "Find the code to this project 
                                  on Github")
                ...
                tabItem(tabName = "Data", 
                        fluidPage(titlePanel("Filter by country"),
                                  box(selectInput("countries", "Select a country", 
                                                  choices = unique(countries)),
                                      
                                    tableOutput(outputId = "countries"), width = 12, 
                ...
                tabItem(tabName = "Charts", 
                    fluidPage(mainPanel(width = 12, 
                        tabsetPanel(
                            ...
                            tabPanel("Cases worldwide line", titlePanel("Cases with line"), plotOutput("worldwide_cases")))), 
